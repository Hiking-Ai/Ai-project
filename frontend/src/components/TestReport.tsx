...
export function TestReport() {
  ...
  const allAnsweredThisPage = currentQuestions.every(
    (_, idx) => answers[startIdx + idx] !== 0
  );
                      ...
                      {q.options.map((opt, idx) => (
                        ...
                        >
                          <input
                            ...
                            value={opt.score}
                            checked={answers[globalIdx] === opt.score}
                            onChange={() => handleSelect(globalIdx, opt.score)}
                            className="sr-only"
                          />
                          <span
